...
import 'package:last_prj/pages/drawer/home_drawer.dart';
import 'package:last_prj/pages/login/auth_method.dart';
import 'package:last_prj/pages/main/home_view.dart';
import '../login/widgets/email_card.dart';
                                  ...
                                  Visibility(
                                    ...
                                    child: EmailCard(
                                      onLoginPressed: (email, password) async {
                                        ...
                                        isBusy = true;
                            AuthMethod().signInWithEmail(email, password).then((value) {
                              isBusy = false;
                              if(value == null)
