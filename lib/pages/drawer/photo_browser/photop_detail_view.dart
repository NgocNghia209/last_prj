...
import 'package:last_prj/pages/drawer/photo_browser/photo_browser_view.dart';
    ...
    return Scaffold(
      body: Column(
        children: [
           ...
           Wrap(
             children: tags.map((e) {return TextButton(child: Text(e), onPressed: (){
               Navigator.of(context).pop();
               Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=> PhotoBrowserView(tag: e,)));
             });}).toList(),
           ),
        ],
      ),
